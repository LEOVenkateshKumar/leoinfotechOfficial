...
<div class="max-w-2xl mx-auto">
    <div class="neu-card p-6 mb-6">
        <h1 class="text-2xl font-bold">➡️ <?php echo clean($user['name']); ?> is Following</h1>
        <p class="text-gray-600 dark:text-gray-400"><?php echo count($following); ?> following</p>
    </div>
    ...
    <div class="neu-card p-12 text-center text-gray-500">
        ...
        <a href="/user/feed.php?type=trending" class="neu-button px-6 py-3 rounded-full mt-4 inline-block">Discover Users</a>
    </div>
    <?php else: ?>
    <div class="space-y-4">
...
<script>
// Same toggleFollow function as followers.php
